  ...
  useEffect(() => {
    const fetchLivros = async () => {
      try {
        ...
        setLivros(response.data.data); // Acesse response.data.data
      } catch (error) {
            ...
            <div className="col-md-4 mb-4" key={livro.id}>
              <div className="card h-100">
                <div className="card-body d-flex flex-column">
                  ...
                  <div className="livro-actions"> {/* Aplicando a nova classe */}
                    <Link to={`/edit/${livro.id}`} className="btn btn-warning">
                      Editar
                    </Link>
                    <button
